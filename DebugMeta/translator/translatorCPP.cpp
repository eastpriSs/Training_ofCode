...
class AniolScriptAbilityes{
    ...
    public:
        ...
        int factorial(const std::vector<std::string> &args){
            ...
            switch (namesOfAllVariables[args[0]])
            {
            case _INT: n = vrI[args[0]];
                break;
            case _FLOAT: n = vrF[args[0]];
                break;
            case _DOUBLE: n = vrD[args[0]];
                break;
            default:
                n = std::stoi(args[0]);
            }            
        ...
        void putValueToVar(std::string variableName, std::string value){
            ...
            if (typeOfVar != 0){
                ...
                namesOfAllVariables[variableName] = typeOfVar;
            }
        ...
        */
        ...
        {             
            ...
            str = (namesOfAllVariables[args[0]] == STRING)?vrS[args[0]]:args[0];
...
//  ===========================================
    ...
    void AnalysCode( char chars[], int count_elements ){
                    ...
                    if (varArgumentsCall)
                    {
                        ...
                        if (symbol_now == ')')
                        {
                            ...
                            if (lastCall == FACTORIAL){
                                ...
                                *local = factorial(listOfManyArguments);
    ...
    // =====================================================================================================================
                ...
                // Ветвление    
                    if (lastCall == IF_SYN || lastCall == EMPTY){
                ...
                if (argumetsAdding){
                    ...
                    // Если использованнно ветвление if(num == 10){} и for(a < 10){}       ----  lastCall == EMPTY для облегчения синтаксиса.
                    if (lastCall == IF_SYN || lastCall == EMPTY || lastCall == FOR_SYN){
...
public:
    ...
    */
    ...
    // =================================================
        ...
        AnalysCode(arrayOfChar, number_chars );
...
int main(){
    ...
    std::string file;
    std::cout << "DIRECT files: " << std::endl;
    system("ls");
    std::cout << "Enter file's name.. (.ks)" << std::endl;
    std::cout << ": ";
    std::getline(std::cin, file);
    
    AniolScriptParserCode Code(file);
